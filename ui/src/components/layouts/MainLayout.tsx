...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  // R5164: Zen Mode - hide all panels for distraction-free editing
  ...
  return (
    <div className="flex flex-col h-screen bg-[#0a0a0b] text-text-primary overflow-hidden">
      {/* Modern Title Bar - Hidden in Zen Mode */}
      {!zenMode && (
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Left: Worktree Panel - Hidden in Zen Mode */}
        {!zenMode && (
          <div
        ...
        {/* Right: Supervisor Panel - Hidden in Zen Mode */}
        {!zenMode && (
          <div
            className={`transition-all duration-300 ease-in-out shrink-0 ${
              rightCollapsed ? 'w-0' : ''
      ...
      {/* Bottom: Tab Panel (Agents + Console) - Hidden in Zen Mode */}
      {!zenMode && !bottomCollapsed && (
        <div
          className="transition-all duration-300 ease-in-out shrink-0"
