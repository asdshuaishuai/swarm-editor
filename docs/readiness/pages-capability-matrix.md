...
| Dynamic graph-aware Swarm | Ready | Planner creates a dependency DAG; scheduler combines critical path, downstream reach, bridge centrality, retries, capacity, and ownership gates. | Graph, planner, scheduler, dependency integration, and scheduling-policy tests. |
